// Standalone Mock SDK Implementation for Testing
// Purpose: Provides a mock SDK without extending the interface

class StandaloneMockSDK {
  constructor(config) {
    this.config = config;
...
module.exports = StandaloneMockSDK;