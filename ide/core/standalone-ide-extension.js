// Standalone IDE Extension Implementation
// Purpose: Core implementation of IDE Extension without extending the interface

const { spawn } = require('child_process');
const path = require('path');
const fs = require('fs').promises;

class StandaloneIDEExtension {
  constructor(sdk) {
    if (!sdk) {
...
module.exports = StandaloneIDEExtension;